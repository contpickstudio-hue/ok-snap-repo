 ...
 * @returns {string} Public site URL, defaults to https://recipes.ok-snap.com
 */
function getPublicSiteUrl() {
    return process.env.PUBLIC_SITE_URL || 'https://recipes.ok-snap.com';
}
...
function getApiBaseUrl(req = null) {
    ...
    // Default fallback (production API host; override with API_BASE_URL)
